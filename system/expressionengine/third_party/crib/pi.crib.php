...
class Crib {
	...
	function usage()
	{
		...
		?>
			...
			To use this plugin, add the following tag to a page template:

			{exp:crib url_list_path="http://www.example.com/urllist.txt" channel_id="1" category_ids="1" body_field_id="1" body_field_format="xhtml"}
			
			urllist.txt should be a simple text file with fully qualified URLs on separate lines.
